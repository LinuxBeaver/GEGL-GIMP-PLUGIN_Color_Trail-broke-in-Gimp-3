...
property_double (bradius, _("Blur radius"), 0)
...
property_int  (radius, _("Median Blur to treat off color pixel outline bug (SLOW)"), 2)
  value_range (0, 15)
  ui_range    (0, 15)
  ui_meta     ("unit", "pixel-distance")
...
static void attach (GeglOperation *operation)
{
  ...
  GeglNode *input, *output, *behind, *f1, *f2, *f3, *f4, *f5, *median;
  ...
  gegl_node_link_many (input, f1, f2, f3, f4, f5, median, NULL);
  gegl_node_connect_from (behind, "aux", median, "output");
  ...
  gegl_operation_meta_redirect (operation, "bradius", f1, "radius");
  gegl_operation_meta_redirect (operation, "bradius", f2, "radius");
  gegl_operation_meta_redirect (operation, "bradius", f3, "radius");
  gegl_operation_meta_redirect (operation, "bradius", f4, "radius");
  gegl_operation_meta_redirect (operation, "bradius", f5, "radius");
  ...
  gegl_operation_meta_redirect (operation, "opacity", f2,"opacity");
  gegl_operation_meta_redirect (operation, "opacity", f3,"opacity");
  gegl_operation_meta_redirect (operation, "opacity", f4,"opacity");
  gegl_operation_meta_redirect (operation, "opacity", f5,"opacity");
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "title",       _("Color Fill Trail and MultiStroke"),
    "categories",  "Artistic",
    "reference-hash", "41ag1g3b0917avx65493xc254001b2ac",
    "description", _("GEGL Color Fill Trail - CHANGE CLIPPING MODE TO CLIP FOR FILTER TO WORK! - Sliding a colors opacity to 0 will hide a trail/stroke."
                     ""),
    NULL);
}
