...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "description", _("GEGL Color Fill Trail. Use behind blend mode or make a back up layer. Setting a color to transparency removes it. Sometimes the color change will not update until x or y positions move or adjust is changed to clip "
                     ""),
    NULL);
}
